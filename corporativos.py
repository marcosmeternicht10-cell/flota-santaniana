...
def puede_cargar_servicio(chofer_usuario, fecha, tramo, hora_inicio="",
    ...
    No hay tope de cantidad: puede encadenar todos los tramos que le entren en
    el día. Lo único que no puede es que dos servicios se pisen en el horario,
    porque nadie está en dos lugares a la vez.

    Los suspendidos no ocupan tiempo y los variables no se controlan, porque
    son justamente lo que se hace fuera de la grilla.
    """
