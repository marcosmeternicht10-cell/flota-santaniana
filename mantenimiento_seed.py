...
PLAN_MB_LO915 = {
    "nombre": "Mercedes-Benz LO-915 (Marcopolo Senior)",
    "descripcion": ("Plan para micros Marcopolo Senior sobre chasis Mercedes-Benz LO-915. "
                    "Ojo: 'Senior' es la carrocería, no la marca — va tanto sobre VW como "
                    "sobre Mercedes, y por eso estos coches habían quedado como Volkswagen. "
                    "Intervalos tomados del plan que venían siguiendo, a confirmar con los "
                    "datos del motor."),
    "tareas": [
        ("Aceite de motor",                     15000, "Lubricación"),
        ("Filtro de aceite",                    15000, "Filtros"),
...
PLANES_PREDEFINIDOS = [
    ...
    PLAN_VW_SENIOR, PLAN_MB_LO915, PLAN_AGRALE_VOLARE, PLAN_HYUNDAI_H350,
]
...
def cargar_planes_default():
    ...
    configs_neumaticos = {
        ...
        "Mercedes-Benz LO-915 (Marcopolo Senior)": {"config": "4x2", "medida": "215/75 R17.5", "vida_km": 100000, "presion_dir": 90, "presion_trac": 100},
