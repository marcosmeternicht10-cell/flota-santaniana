...
def api_chofer_reportar():
    ...
    El sistema detecta automáticamente el tipo (correctivo/preventivo/etc)."""
    ...
    try:
        ...
        # Detección automática del tipo según lo que escribió el chofer
        ...
        ot_id = crear_ot(
            ...
            items=[{"descripcion": descripcion, "tipo": tipo, "estado": "pendiente"}]
        )
        return jsonify({"ok": True, "ot_id": ot_id, "tipo_detectado": tipo,
                        "msg": "¡Reporte enviado al taller!"})
    except (KeyError, ValueError) as e:
