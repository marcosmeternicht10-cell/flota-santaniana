...
const LABEL_ROL = { admin: "Administración", taller: "Taller" };
        ...
        <div class="card-body">
          <div class="form-row">
            ...
            <div class="field"><label>Rol</label>
              <select id="u-rol" style="width:180px">
          ...
          <p class="hint" style="margin-top:14px">
            ...
            <b>Taller</b>: gestiona órdenes de trabajo, mantenimiento, neumáticos, correctivos y todo lo operativo. <b>Administración</b>: acceso total + puede crear y administrar usuarios.
          </p>
        </div>
      </div>
