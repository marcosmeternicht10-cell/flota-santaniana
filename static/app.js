  ...
  cont.innerHTML = `
    <div class="metrics" style="margin-bottom:18px">
      <div class="metric"><div class="metric-content"><div class="metric-label">Cobertura</div>
        <div class="metric-value" style="color:${cobGlobal >= 90 ? "var(--success)" : cobGlobal >= 70 ? "var(--warning)" : "var(--danger)"}">${cobGlobal}%</div></div></div>
      <div class="metric"><div class="metric-content"><div class="metric-label">Tramos cubiertos</div><div class="metric-value">${totCub} / ${totEsp}</div></div></div>
      <div class="metric"><div class="metric-content"><div class="metric-label">Sin cubrir</div><div class="metric-value" style="color:var(--danger)">${totFal}</div></div></div>
      <div class="metric"><div class="metric-content"><div class="metric-label">A medias</div><div class="metric-value" style="color:var(--warning)">${totPar}</div></div></div>
      <div class="metric"><div class="metric-content"><div class="metric-label">Costo total</div><div class="metric-value">Gs. ${fmtNum(cos.costo_total)}</div></div></div>
    </div>
