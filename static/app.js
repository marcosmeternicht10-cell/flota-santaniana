  ...
  content.innerHTML = `
    ...
    <div class="section">
      <div style="display:flex;justify-content:flex-end;margin-bottom:14px">
        <button class="btn btn-ghost" onclick="abrirReporteCorrectivos()"><i class="ti ti-printer"></i> Imprimir por fechas</button>
      </div>
      <div class="card">
...
const LABEL_ROL = { admin: "Administración", taller: "Taller", chofer: "Chofer" };
