...
async function cargarControlEmpresa() {
  ...
  cont.innerHTML = `
    ...
    ${cob.length ? `
    <div class="card">
      <div class="card-head"><i class="ti ti-checklist"></i> ¿Se reportaron todos los tramos?</div>
      <div class="table-wrap">
        <table>
          <thead><tr><th>Empresa</th><th class="center">Días</th><th class="center">Esperados</th>
          ...
          <tbody>
            ${cob.map(c => `<tr>
              ...
              <td class="center">${c.esperados}</td>
              <td class="center" style="color:var(--success)"><b>${c.cubiertos}</b></td>
              <td class="center" style="color:var(--warning)">${c.parciales || "—"}</td>
              <td class="center">${c.suspendidos || "—"}</td>
              <td class="center" style="color:var(--danger)"><b>${c.faltantes || "—"}</b></td>
              <td class="center"><span class="badge ${c.cobertura >= 90 ? "success" : c.cobertura >= 70 ? "" : "danger"}">${c.cobertura}%</span></td>
            </tr>`).join("")}
          </tbody>
        </table>
      </div>
    ...
    <div class="card">
      <div class="card-head"><i class="ti ti-cash"></i> Costo por empresa</div>
      <div class="table-wrap">
        <table>
    ...
    <div class="card">
      ...
      ${vars.cantidad === 0
        ...
        : `<div class="table-wrap"><table>
            ...
            <tbody>
              ${vars.variables.map(v => `<tr class="${!(v.observacion || "").trim() ? "item-en-espera" : ""}">
                ...
                <td style="font-size:12.5px">${(v.observacion || "").trim() || '<span style="color:var(--danger)"><i class="ti ti-alert-triangle"></i> sin justificar</span>'}</td>
