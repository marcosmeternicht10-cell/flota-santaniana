      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-row" style="align-items:flex-end">
            ...
            <div class="field"><label>Pagos desde</label><input id="hist-desde" type="date" value="${fmt(haceUnAnio)}"></div>
            <div class="field"><label>Pagos hasta</label><input id="hist-hasta" type="date" value="${fmt(hoy)}"></div>
          ...
          <p class="hint" style="margin-top:12px"><i class="ti ti-info-circle"></i> Las fechas filtran por <b>cuándo se pagó</b>, no por cuándo se prestó el servicio.</p>
        </div>
      </div>
...
async function cargarHistorial() {
  ...
  if (pagos.length === 0) {
    cont.innerHTML = `<div class="empty"><i class="ti ti-receipt-off"></i>No hay pagos registrados en este período.<br><span style="font-size:12px;color:var(--muted)">Los pagos aparecen acá cuando liquidás una semana desde el Resumen de rendiciones.</span></div>`;
    return;
  }
        ...
        <table>
          ...
          <tbody>
            ${pagos.map(p => `<tr>
              ...
              <td style="font-size:12px;color:var(--muted)">${p.periodo_desde} a ${p.periodo_hasta}</td>
