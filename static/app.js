...
const BUS_LAYOUTS = {
  "4x2": { w: 340, h: 210, bus:{x:55,y:55,w:230,h:100}, pos:{
    "DI":{x:90,y:42,l:"DI"},"DD":{x:90,y:168,l:"DD"},
    "TI-Ext":{x:250,y:42,l:"TI"},"TD-Ext":{x:250,y:168,l:"TD"} } },
  "6x2": { w: 460, h: 230, bus:{x:55,y:65,w:350,h:100}, pos:{
    "DI":{x:95,y:50,l:"DI"},"DD":{x:95,y:180,l:"DD"},
    "TI-Ext":{x:335,y:32,l:"TI-E"},"TI-Int":{x:335,y:82,l:"TI-I"},
    "TD-Ext":{x:335,y:198,l:"TD-E"},"TD-Int":{x:335,y:148,l:"TD-I"} } },
  "6x2/3": { w: 560, h: 210, bus:{x:55,y:55,w:450,h:100}, pos:{
    "DI":{x:95,y:42,l:"DI"},"DD":{x:95,y:168,l:"DD"},
    "TI-Ext":{x:290,y:30,l:"TI-E"},"TI-Int":{x:290,y:74,l:"TI-I"},
    "TD-Ext":{x:290,y:180,l:"TD-E"},"TD-Int":{x:290,y:136,l:"TD-I"},
    "AI":{x:435,y:42,l:"AI"},"AD":{x:435,y:168,l:"AD"} } },
  "8x2": { w: 620, h: 210, bus:{x:55,y:55,w:510,h:100}, pos:{
    "DI":{x:95,y:42,l:"DI"},"DD":{x:95,y:168,l:"DD"},
    "TI-Ext":{x:335,y:30,l:"TI-E"},"TI-Int":{x:335,y:74,l:"TI-I"},
    "TD-Ext":{x:335,y:180,l:"TD-E"},"TD-Int":{x:335,y:136,l:"TD-I"},
    "AI-Ext":{x:500,y:30,l:"AI-E"},"AI-Int":{x:500,y:74,l:"AI-I"},
    "AD-Ext":{x:500,y:180,l:"AD-E"},"AD-Int":{x:500,y:136,l:"AD-I"} } },
  "4patas": { w: 650, h: 220, bus:{x:55,y:60,w:545,h:100}, pos:{
    "DI":{x:105,y:46,l:"DI"},"DD":{x:105,y:176,l:"DD"},
    "TI-Ext":{x:295,y:28,l:"TI-E"},"TI-Int":{x:295,y:74,l:"TI-I"},
    "TD-Ext":{x:295,y:192,l:"TD-E"},"TD-Int":{x:295,y:146,l:"TD-I"},
    "AI":{x:425,y:46,l:"AI"},"AD":{x:425,y:176,l:"AD"},
    "RI":{x:555,y:46,l:"RI"},"RD":{x:555,y:176,l:"RD"} } },
  "camioneta": { w: 340, h: 210, bus:{x:55,y:60,w:230,h:90}, pos:{
    "DI":{x:90,y:46,l:"Del.Izq"},"DD":{x:90,y:164,l:"Del.Der"},
    "TI-Ext":{x:250,y:46,l:"Tra.Izq"},"TD-Ext":{x:250,y:164,l:"Tra.Der"} } },
  "2ejes": { w: 400, h: 230, bus:{x:55,y:65,w:280,h:100}, pos:{
    "DI":{x:100,y:50,l:"Dir.Izq"},"DD":{x:100,y:180,l:"Dir.Der"},
    "TI-Ext":{x:300,y:32,l:"TraI-E"},"TI-Int":{x:300,y:82,l:"TraI-I"},
    "TD-Ext":{x:300,y:198,l:"TraD-E"},"TD-Int":{x:300,y:148,l:"TraD-I"} } },
  "3ejes": { w: 520, h: 210, bus:{x:55,y:55,w:410,h:100}, pos:{
    "DI":{x:95,y:42,l:"Dir.Izq"},"DD":{x:95,y:168,l:"Dir.Der"},
    "MI-Ext":{x:310,y:30,l:"MedI-E"},"MI-Int":{x:310,y:74,l:"MedI-I"},
    "MD-Ext":{x:310,y:180,l:"MedD-E"},"MD-Int":{x:310,y:136,l:"MedD-I"},
    "TI-Ext":{x:425,y:42,l:"Tra.Izq"},"TD-Ext":{x:425,y:168,l:"Tra.Der"} } },
  "4ejes": { w: 620, h: 210, bus:{x:55,y:55,w:510,h:100}, pos:{
    "D1I":{x:100,y:42,l:"Dir1Izq"},"D1D":{x:100,y:168,l:"Dir1Der"},
    "D2I":{x:190,y:42,l:"Dir2Izq"},"D2D":{x:190,y:168,l:"Dir2Der"},
    "MI-Ext":{x:410,y:30,l:"PenI-E"},"MI-Int":{x:410,y:74,l:"PenI-I"},
    "MD-Ext":{x:410,y:180,l:"PenD-E"},"MD-Int":{x:410,y:136,l:"PenD-I"},
    "TI-Ext":{x:520,y:42,l:"Tra.Izq"},"TD-Ext":{x:520,y:168,l:"Tra.Der"} } },
};

// Color del neumático según su estado de desgaste
...
// SVG del bus con ruedas arrastrables
function generarSvgBusDrag(data) {
  ...
  let svg = `<svg class="neu-svg" viewBox="0 0 ${layout.w} ${layout.h}" xmlns="http://www.w3.org/2000/svg">`;
  // Carrocería
  svg += `<rect x="${b.x}" y="${b.y}" width="${b.w}" height="${b.h}" rx="22" fill="#F1F4F9" stroke="#1E5A96" stroke-width="2.5"/>`;
  // Parabrisas (frente)
  svg += `<path d="M ${b.x} ${b.y+18} Q ${b.x+5} ${b.y+8} ${b.x+30} ${b.y+8} L ${b.x+30} ${b.y+b.h-8} Q ${b.x+5} ${b.y+b.h-8} ${b.x} ${b.y+b.h-18} Z" fill="#1E5A96" opacity="0.15"/>`;
  svg += `<text x="${b.x+15}" y="${b.y+b.h/2+4}" font-size="9" fill="#1E5A96" font-weight="700" text-anchor="middle">FRENTE</text>`;
  ...
  for (const [pos, c] of Object.entries(layout.pos)) {
    ...
    if (vacia) {
      const lblY = pos.includes("-Int") ? c.y + 30 : c.y - 21;
      svg += `<g class="neu-wheel neu-wheel-empty" data-pos="${pos}">
        <title>${pos} — vacía, soltá una cubierta acá</title>
        <ellipse class="neu-slot" cx="${c.x}" cy="${c.y}" rx="17" ry="13"/>
        <text class="neu-wheel-lbl" x="${c.x}" y="${lblY}">${c.l}</text>
        <text class="neu-slot-plus" x="${c.x}" y="${c.y + 4}">+</text>
      </g>`;
    } else {
      const col = COLOR_DESGASTE[n.estado_grad] || COLOR_DESGASTE.optimo;
      const lblYf = pos.includes("-Int") ? c.y + 30 : c.y - 21;
      svg += `<g class="neu-wheel neu-wheel-full" data-pos="${pos}" data-nid="${n.neumatico_id}" draggable="true">
        <title>${n.codigo} — ${n.porcentaje_uso.toFixed(0)}% usado (${fmtNum(n.km_totales)} km)</title>
        <ellipse class="neu-tire" cx="${c.x}" cy="${c.y}" rx="17" ry="13" fill="${col.fill}" stroke="${col.stroke}" stroke-width="1.5"/>
        <text class="neu-wheel-lbl" x="${c.x}" y="${lblYf}">${c.l}</text>
        <text class="neu-tire-pct" x="${c.x}" y="${c.y + 4}" fill="${col.text}">${Math.round(n.porcentaje_uso)}%</text>
      </g>`;
    }
  }
  svg += `</svg>`;
