...
const LABEL_EST_COMPRAS = { en_espera: "En espera", presupuestado: "Presupuestadas", entregado: "Entregadas" };
...
async function renderCompras() {
  ...
  const lista = comprasTab === "en_espera" ? enEspera : comprasTab === "presupuestado" ? presup : entreg;
...
async function abrirOT(otId) {
  ...
  const LABEL_COMPRAS = { en_espera: "En espera (Compras)", presupuestado: "Presupuestado", entregado: "Entregado" };
  const COLOR_COMPRAS = { en_espera: "warning", presupuestado: "cat", entregado: "success" };
