        ...
        <table>
          ...
          <tbody>
            ${liq.map(l => `<tr>
              ...
              <td class="center">${l.chofer_usuario ? `<button class="btn btn-ghost" style="padding:5px 10px;font-size:12px" onclick="abrirLiquidacion('${l.chofer_usuario}','${l.chofer_nombre.replace(/'/g,"\\'")}')"><i class="ti ti-cash"></i> Liquidar</button>` : "—"}</td>
            </tr>`).join("")}
