...
async function cargarCombCorp() {
  ...
  if (!r.cargas) {
    cont.innerHTML = `<div class="empty"><i class="ti ti-gas-station-off"></i>No hay cargas de combustible en este período.<br>
      <span style="font-size:12px;color:var(--muted)">Aparecen acá cuando los choferes las registran desde el celular.</span></div>`;
    return;
  }
  ...
  if (tab === "bus") {
    ...
    return `<div class="card"><div class="table-wrap"><table>
      <thead><tr><th>Bus</th><th>Patente</th><th class="center">Cargas</th><th class="num">Litros</th>
        <th class="center">Consumo<br><span style="font-weight:400;text-transform:none">L cada 100 km</span></th>
        <th class="center">vs. su motor</th><th class="num">Costo</th><th style="width:110px"></th></tr></thead>
...
function chipDesvio(comp) {
  if (!comp) return `<span style="color:var(--lighter);font-size:11.5px" title="Asignale un plan de mantenimiento al bus para tener referencia">sin referencia</span>`;
